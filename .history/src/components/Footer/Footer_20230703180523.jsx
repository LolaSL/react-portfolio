  ...
  return (
    <div className="footer">
      <div className="socialMedia">
        ...
        <a href={'https://www.instagram.com/shepota68' }><FacebookIcon /></a>
        <a href={'https://www.instagram.com/shepota68' }><LinkedInIcon /></a>
        <a href={'https://www.instagram.com/shepota68' }><GitHubIcon /></a>
